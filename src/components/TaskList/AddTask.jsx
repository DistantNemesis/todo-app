    ...
    return (
        <>
            <form className="add-task-form" onSubmit={onSubmit}>
                ...
                <textarea id="task-description" style={{ resize: 'none' }} required cols={70} rows={20} placeholder="Task Description" value={taskDescription} onChange={(e) => setTaskDescription(e.target.value)} />
